...
import { DeepPartial, GatewayToken } from "../types";
...
export declare const defaultRetryConfig: {
    retryCount: number;
    exponentialFactor: number;
    timeouts: {
        processed: number;
...
export declare const runFunctionWithRetry: (methodName: string, fn: () => Promise<unknown>, commitment: Commitment, customRetryConfig: DeepPartial<RetryConfig>) => Promise<unknown>;
export declare const proxyConnectionWithRetry: (originalConnection: Connection, customRetryConfig?: DeepPartial<RetryConfig>) => Connection;
/**
 * Derive the address of the gatekeeper PDA for this gatekeeper
 * @param authority The gatekeeper
 * @param network The network
 */
export declare const getGatekeeperAccountKey: (authority: PublicKey, network: PublicKey) => Promise<PublicKey>;
/**
 ...
 */
export declare const getGatewayTokenKeyForOwner: (owner: PublicKey, gatekeeperNetwork: PublicKey, seed?: Uint8Array | undefined) => Promise<PublicKey>;
